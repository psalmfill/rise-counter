...
mod test {
    ...
    fn test_counter() {
        ...
        let mut second_decrement_instruction_data: Vec<u8> = vec![1];
        ...
        let dec_value = 2u32;
        second_decrement_instruction_data.extend_from_slice(&dec_value.to_le_bytes());
        process_instruction(&program_id, &accounts, &second_decrement_instruction_data).unwrap();
